@props(['path', 'title', 'price', 'image', 'class', 'id_product'])
    <div class=" relative flex w-full flex-col overflow-hidden rounded-lg border border-gray-100  shadow-md">
        ...
        <div class="mt-4 px-5 pb-5">
          ...
          <button data-product-id="{{ $id_product }}" id="add-to-cart" class="w-full flex items-center justify-center rounded-md bg-green-700 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-green-600 focus:outline-none focus:ring-4 focus:ring-blue-300">
